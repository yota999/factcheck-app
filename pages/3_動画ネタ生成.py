...
REEL_ANGLES = [
    "骨盤の前傾・後傾とぽっこりお腹の関係",
    "腸腰筋（インナーマッスル）と下腹が出る仕組み",
    "筋膜の癒着と体型が変わりにくくなる理由",
    "横隔膜の動きと体幹・お腹まわりの形の関係",
    "股関節の詰まりと太もも・お尻の張りの仕組み",
    "肩甲骨の位置と猫背・巻き肩になる解剖学的な理由",
    "足のアーチ（土踏まず）と膝・腰・姿勢への影響",
    "大臀筋（お尻の筋肉）が使えないと起きる体型変化",
    "胸郭（肋骨）の硬さと呼吸・姿勢・体型の関係",
    "腹横筋（お腹を締める筋肉）と腰痛・ぽっこりお腹の仕組み",
    "脊椎のS字カーブが崩れると体型に起きること",
    "膝関節のアライメント（向き・並び）とO脚・X脚の仕組み",
    "僧帽筋（首〜肩の筋肉）の緊張と姿勢・肩こりの解剖学",
    "骨盤底筋群と下腹ぽっこり・尿もれの関係",
    "股関節外旋筋（梨状筋など）と脚の太さ・むくみの仕組み",
]
...
■ ありきたりな食事・生活習慣系
・PFCバランス / タンパク質を摂りましょう / 有酸素運動
・カロリー計算 / 食事制限 / 水を飲みましょう
→ ダイエット一般論はNG

【出力すること】
・筋肉・関節・骨格・筋膜・姿勢のどれかに関係する話
・「その筋肉が使えないとこうなる」「その関節がこうなると体型がこう変わる」という構造的な話
・「え、骨盤ってそういう動きをしてたの！？」という体の仕組みへの驚きがある内容
・専門用語は1〜2個まで使ってOK（ただし括弧で一言補足を入れる）
・ある程度の解剖学的根拠があること
